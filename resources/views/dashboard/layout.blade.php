...
<div class="topbar">
  ...
  <nav class="links">
    ...
    <a href="{{ url('/dashboard/food-history') }}" class="{{ request()->is('dashboard/food-history') ? 'active' : '' }}">History</a>
    <a href="{{ url('/dashboard/food-chat') }}" class="{{ request()->is('dashboard/food-chat') ? 'active' : '' }}">Ask AI</a>
    <a href="{{ url('/dashboard/profile') }}" class="{{ request()->is('dashboard/profile') ? 'active' : '' }}">Profile</a>
